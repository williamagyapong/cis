          ...
          <div id="page-inner">
            ...
            <div class="w3-main" style="">
              ...
              <header id="portfolio">
                ...
                <h2 id="top-page">System Settings</h2>
                <div class="w3-section w3-bottombar w3-padding-16">
                  <button class="w3-button w3-blue"><a href="#first_row">First Row</a></button>
                      ...
                      <form id="reset_password_form" action="../controller.php" method="post" class="w3-container w3-card-4 w3-padding w3-card w3-padding-34">
                        <div class="w3-row-padding">
                         <label class="w3-bold" for="old_password">Old Password:</label><br>
                          ...
                          <button onclick="" id="reset_password" class="btn btn-primary w3-margin-top">RESET</button>
                         <img class="w3-margin-top" style="margin-left: 70px;" src="../assets/images/system/ajax-loader.gif">
                        </div>
                      </form>
                    </div>
              ...
              <div class="w3-black w3-center w3-padding-24">Powered by <a href="#" title="developer" target="_blank" class="w3-hover-opacity w3-text-orange"><?php echo Config::get('developer/name');?></a></div>
