        ...
        <div class="w3-row" id="top-page">
            <div class="w3-col m6 l6">  
               <div class="w3-padding-left w3-mobile">
                  <h3><span class="w3-badge w3-xlarge w3-padding w3-blue-grey">Baptism Register</span></h3>
               </div>
            </div>
            <div class="w3-col m6 l6">
              <h3>
                Total Baptisms recorded: <span class="w3-blue w3-large w3-text-white badge"><?php echo count($baptisms);?></span>
                <span class="w3-right btn btn-primary" onclick="popUpModal('../controller.php','new_baptism_ui')">New</span>
              </h3>
            </div>
        </div>              
         <!-- /. ROW  -->
