                  ...
                  <div class="panel-head">
                      <div class="panel-body">
                          <div class="table-responsive">
                             <table class="table table-striped table-bordered table-hover" id="marriages_table">
                               <thead>
                                 <tr>
                                   <th>Marriage ID</th>
                                   <th>Bride</th>
                               ...
                               <tbody>
                                 <?php foreach($marriages as $person):?>
                                  <tr>
