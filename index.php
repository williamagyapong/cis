  ...
  require_once'settings.php';
   if(Input::exist('login')) {
    $errorMsg = [];
      ...
      if(!Token::check(Input::get('csrf_token'))) $errorMsg[] ="Please log in from the authorized page";
    ...
    <div class="header">
     ...
     <form id="stdloginform" action="index.php" method="post">
      ...
      <div class="page">
              ...
              <tr>
                  <td>User Name</td>
                  <td><input type="text" tabindex="1" name="username" value="<?php echo Input::get('username');?>" required /></td>

              </tr>
              <tr>
                  <td>Password</td>
                  <td><input type="password" tabindex="2" name="password" value="<?php echo Input::get('username');?>" required/></td>
              </tr>
